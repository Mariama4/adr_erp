frappe.pages['budget-operations-excel-editor'].on_page_load = function(wrapper) {
	if (!$("link[href='https://cdn.jsdelivr.net/npm/handsontable/styles/handsontable.min.css']").length) {
		$('head').append('<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/handsontable/styles/handsontable.min.css" />');
	}
	if (!$("link[href='https://cdn.jsdelivr.net/npm/handsontable/styles/ht-theme-main.min.css']").length) {
		$('head').append('<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/handsontable/styles/ht-theme-main.min.css" />');
	}
...
PageContent = Class.extend(
	{
		...
		make: function () {
			...
			frappe.db.get_list('organization-bank rules', {
				fields: [],
				filters: {
				  is_active: true
				}
			...
			$(
				frappe.render_template(
					'budget_operations_excel_editor', this
				)
			).appendTo(
				this.page.main
			)
